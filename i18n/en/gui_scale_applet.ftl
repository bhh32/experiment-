...
# Additional Tail Drop
taildrop-inbox = Inbox
taildrop-no-waiting = No files waiting.
taildrop-waiting-count = { $count } file(s) waiting in inbox
taildrop-choose-device = Choose a device first.
