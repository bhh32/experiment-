...
# Status adicional
status-dns-suffix = Sufixo DNS

# Tail Drop adicional
taildrop-inbox = Caixa de entrada
taildrop-no-waiting = Nenhum arquivo em espera.
taildrop-waiting-count = { $count } arquivo(s) na caixa de entrada
taildrop-choose-device = Escolha um dispositivo primeiro.
