...
# Algemeen
select-default = Selecteren
none-default = Geen
copy-tooltip = Kopiëren
...
# Aanvullende status
status-dns-suffix = DNS-achtervoegsel

# Aanvullende Tail Drop
taildrop-inbox = Postvak IN
taildrop-no-waiting = Geen bestanden in afwachting.
taildrop-waiting-count = { $count } bestand(en) in postvak
taildrop-choose-device = Kies eerst een apparaat.
